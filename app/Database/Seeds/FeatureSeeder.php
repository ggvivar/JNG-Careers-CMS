...
class FeatureSeeder extends Seeder
{
    public function run()
    {
        ...
        $features = [
            ...
            ['module' => 'Admin', 'name' => 'Companies', 'code' => 'companies', 'sort_order' => 6],
            ['module' => 'Admin', 'name' => 'Departments', 'code' => 'departments', 'sort_order' => 7],
            ['module' => 'Admin', 'name' => 'Site Settings', 'code' => 'site-settings', 'sort_order' => 8],
            ['module' => 'Admin', 'name' => 'Message Templates', 'code' => 'message-templates', 'sort_order' => 9],
            ['module' => 'Admin', 'name' => 'Document Templates', 'code' => 'document-templates', 'sort_order' => 10],
